...
// 비트 연산 활용 예3:
// => 흑백을 반전시키자
// => 방법 : 빛이 있는 점은 빛을 없애고 (1 ==> 0)
//           빛이 없는 점은 빛을 넣는다.(0 ==> 1)
//        ex)다음과 같이 흑색의 한 점이 있다.
//          00000000 00000000 00000000 (변경 전 색 :검)
//        ~ 
//---------------------------------------------------
//          11111111 11111111 11111111 (변경 후 색 :흰)

// 비트 연산 활용 예4;
// => 필터 만들기 
// => 방법 :
// => 특정 비트만 통과시키는 필터 만들기
// => 특정 색성만 제거하는 필터를 만들 때 ^ 연산자를 사용할 수 있다.
// => 다음과 같이 비트 데이터가 있다.
//    11001010 11100100 00111001 (검정)
// ^  00000000 11111111 00000000 (4 ~12 비트를 제외한 나머지 비트 날림)
// ------------------------------------------//
//    11001010 11100100 00111001
//    11101110 00000000 11111011 (필터)
//    00000000 00000000 00000000 (출력 결과) 한 점에 대해 연산한 출력결과가 0이면 해당 점의 색상을 제거하고 0이아니면 원래 색상을 그대로 사용.
