...
public class Exam0910 {
 public static void main(String[] args) {
   ...
   // 변수의 값을 다른 변수에 저ㅕ장하는 기본원칙!
   // - 반드시 같은 데이터 타입이어야 한다.
   // - 같은 데이터 타입이라도 저장하는 값이 
   // - 변수보다 작거나 같아야 한다.
   ...
   System.out.println(f2);
   // int 를 float 에 저장할 때 컴파일 오류는 발생하지 않는다.
   // 다만 실행시에 플롯 메모리에 저장되는 과정에서
   // 유효자릿수가 넘어가는 값을 잘린다.
   ...
   // 단 논리 값은 정수나 부동소수점으로 바꿀 수 없다.(거꾸로도 안됨.)
   // b = (byte) bool
   // s = (short) bool;
   // i = (int) bool;
   // l = (long) bool;
   ...
   // - 형변환 할 때 같이 메모리에 저장하지 못할만큼 크다면 잘린다.
