...
public class RequestMappingListener implements ApplicationContextListener {
  ...
  public void contextInitialized(Map<String,Object> context) {
    try {
      ...
      Member member = memberService.get("a", "1111");
      ...
      context.put("/board/delete", new BoardDeleteCommand(boardService));
          ...
          context.put("/project/add", new ProjectAddCommand(projectService, memberListCommand));
          context.put("/project/list", new ProjectListCommand(projectService));
          context.put("/project/detail", new ProjectDetailCommand(projectService));
          context.put("/project/update", new ProjectUpdateCommand(projectService, memberListCommand));
